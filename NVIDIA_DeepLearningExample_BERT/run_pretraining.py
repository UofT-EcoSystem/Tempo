...
def parse_arguments():
    ...
    # Modified by Tempo: disable jit fusions by default
    # because current Tempo's implementation does not support jit fusion
    # but the of idea Tempo can be used with jit fusions with appropriate implementation
    # so currently for comparison, we disable jit fusions.
