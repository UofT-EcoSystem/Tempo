...
class InplaceLayerNormFunction(autograd.Function):
    ...
    def forward(ctx, input, normalized_shape, weight, bias, eps=1e-5):
        output, _, rstd = layernorm.forward(input, normalized_shape, weight, bias, eps)
    ...
    def backward(ctx, grad_output):
        ...
        dx, dweight, dbias = layernorm.backward(grad_output, output, normalized_shape, rstd, weight, bias, grad_mask)
